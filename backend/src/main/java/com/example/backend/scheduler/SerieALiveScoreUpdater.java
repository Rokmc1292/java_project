...
public class SerieALiveScoreUpdater {
    ...
    public void updateLiveScores() {
        // 세리에 A 리그의 오늘 경기 조회 (SCHEDULED 또는 LIVE 상태)
        List<Match> todayMatches = matchRepository.findTodayMatchesByLeague(8L, LocalDateTime.now());
        ...
        log.info("⚽ [실시간 업데이트] 오늘 세리에 A 경기 {}개 발견, 크롤링 시작", todayMatches.size());
